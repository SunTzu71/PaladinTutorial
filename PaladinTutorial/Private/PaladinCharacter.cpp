...
void APaladinCharacter::Jump()
{
	...
	if (GetCharacterMovement()->IsMovingOnGround())
	{
		...
		// Launch charcter with the combined velocity
...
float APaladinCharacter::TakeDamage(float DamageAmount, FDamageEvent const& DamageEvent, AController* EventInstigator,
	AActor* DamageCauser)
{
